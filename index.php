...
<body data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div id="clients">
        <div class="overlay" style="margin-top: 1px;">
            <div class="container">
                <h1 class="text-center m-0"style="margin-top: -11px;margin-bottom: -5px;">Sports Club</h1>
                        ...
                        <div class="carousel slide clients-carousel" id="clients-slider">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="election.php?cid=Chess">
                                                <img src="assets/img/chess.jpg" alt="1" />
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="election.php?cid=Basketball">
                                                <img src="assets/img/basket.jpg" alt="2" />
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="election.php?cid=cricket">
                                                <img src="assets/img/cricket.jpg" alt="3" />
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="election.php?cid=Volleyball">
                                                <img src="assets/img/voly.jpg" alt="4" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="election.php?cid=Soccer">
                                                <img src="assets/img/Soccer.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="col-md-3">
    ...
    <div id="clients">
        <div class="overlay">
            <div class="container">
                <h1 class="text-center m-0"  style="margin-top: -114px;margin-bottom: -5px;">Other Clubs</h1>
                <div class="row text-center">

                    <div class="col-md-12" data-scroll-reveal="enter from the bottom after 0.2s">
                        <div class="carousel slide clients-carousel" id="client-slider">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="#">
                                                <img src="assets/img/pool.jpg" alt="1" />
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="#">
                                                <img src="assets/img/dance.jpg" alt="2" />
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="#">
                                                <img src="assets/img/music.jpg" alt="3" />
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a class="thumbnail" href="#">
                                                <img src="assets/img/google.png" alt="4" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
